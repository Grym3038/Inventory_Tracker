...
<body class=" bg-custom-blobs text-black">


    <header class="border-gray-200  text-black ">
        <div class="animate-slide-down md:w-[90%] lg:w-[90%] xl:max-w-[75%] md:mx-auto lg:mx-auto px-0 sm:px-5 lg:px-18 py-5 md:bg-[#0000000a] border-b-2 border-[#00000033] md:border-[#cccccc00] md:rounded-2xl lg:rounded-full mt-5">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden lg:flex space-x-10 text-sm lg:text-md">
                    ...
                    <a href="#services" class="text-gray-700 font-semibold hover:text-black transition-all">Pricing</a>
                    <a href="#about" class="text-gray-700 font-semibold hover:text-black transition-all">About Us</a>
                    <a href="#contact" class="text-gray-700 font-semibold hover:text-black transition-all">Contact</a>
                </nav>
            ...
            <div id="mobile-menu" class="lg:hidden mt-5 hidden space-y-4 transition-all duration-100">
                <div class="flex md:hidden justify-around border-b-1 border-gray-300 w-full pb-3">
                    <a href="tel:16059371183" class="bg-gray-200 border-1 border-gray-300 hover:bg-[#003980] font-bold text-gray-700 py-2 px-6 rounded-full text-md lg:text-lg transition-all">
                        Login
                    </a>
                    <a href="tel:16059371183" class="bg-[#0078FF] border-1 border-blue-800 hover:bg-[#003980] font-bold text-white py-2 px-6 rounded-full text-md lg:text-lg transition-all">
                        Start Free Trial
                    </a>
                </div>
